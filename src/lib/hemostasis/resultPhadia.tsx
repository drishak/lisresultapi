...
export async function handleResultPhadia(data: any) {
    let conn;
    ...
    try {
        ...
        console.error("Error in handleResultPhadia:", error);
        throw new Error(error.message || "Failed to handle Phadia result");
    }
}

...
export async function handleResultBactec(data: any) {
    ...
    try {
        ...
        console.error("Error in handleResultBactec:", error);
        throw new Error(error.message || "Failed to handle Bactec result");
    }
}

...
export async function handleResultAlinity(data: any) {
    let conn;
    ...
    try {
        ...
        console.error("Error in handleResultAlinity:", error);
        throw new Error(error.message || "Failed to handle Alinity result");
    }
}

...
export async function handleResultCobas(data: any) {
    let conn;
    ...
    try {
        ...
        console.error("Error in handleResultCobas:", error);
        throw new Error(error.message || "Failed to handle Cobas result");
    }
}
